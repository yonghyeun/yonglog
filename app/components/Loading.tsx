  ...
  <div className='animate-pulse'>
    ...
    <p className='my-3 '>
      <span className='inline py-1 text-[16px] mb-2rem indent-[1px] bg-gray-300 text-gray-300'>
        ...
        soluta distinctio aperiam beatae esse. Non ipsam voluptas quisquam, amet
      </span>
    </p>
    <p className='my-3 '>
      <span className='inline py-1 text-[16px] mb-2rem indent-[1px] bg-gray-300 text-gray-300'>
        ...
        praesentium nihil odio at exercitationem laboriosam tempore
      </span>
    </p>
    <p className='my-3 '>
      <span className='inline py-1 text-[16px] mb-2rem indent-[1px] bg-gray-300 text-gray-300'>
        Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Dolore tempora eaque error odit quod distinctio.
        Eligendi, fuga consectetur adipisicing elit. Assumenda,
      </span>
    </p>
    <p className='my-3 '>
      <span className='inline py-1 text-[16px] mb-2rem indent-[1px] bg-gray-300 text-gray-300'>
