---
title: '/ 경로 레이아웃 , 페이지 디자인 생성하기'
description: tailwind 최고야 너무 편해 ~!!
date: Wed May 29 2024
thumb: app/public/posts/개발 블로그 개발 여정/04. 메인 페이지 레이아웃 디자인 생성하기/layout design.gif
time: 1716940800001
tag:
  - react
  - design
...
하단에 있는 내용들은 모두 `/` 경로를 렌더링 할 때 사용한 컴포넌트들이다.
